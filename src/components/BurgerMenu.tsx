...
const BurgerMenu = () => {
    ...
    return (
            <div className=" h-12 pl-4 md:pl-0 2xl:pl-5 fixed top-4 md:top-4.5 sm:left-4 md:left-4  hover:scale-105 hover:cursor-pointer text-black z-[1000]" onClick={()=>dispatch(toggleMobileMenu())}>
