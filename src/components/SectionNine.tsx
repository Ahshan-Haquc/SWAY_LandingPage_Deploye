...
//         WAYS TO SWAY
//       </h2>
//       <h4 className="text-xs md:text-sm xl:text-lg font-bold mb-1 text-gray-900 text-center">
...
//       {/* cart section */}
//       <div className="mt-8">
//         <h3 className="text-sm md:text-[16px] xl:text-lg text-black text-center mb-2 md:mb-5">
...
//         <h3 className="text-sm md:text-[16px] xl:text-lg text-center text-black">
...
const SectionNine = () => {
  const sortedPricingData = [
    ...pricingData.filter(item => item.title === "FLEX"),
    ...pricingData.filter(item => item.title !== "FLEX"),
  ];
          ...
          {sortedPricingData.map((item, i) => (
            <PricingCart
              ...
              cta={{
                ...item.cta,
                className:
                  "mt-auto px-4 py-2 rounded-2xl font-semibold bg-black text-white hover:bg-red-400 transition-colors",
              }}
            />
          ))}
        </div>
            ...
            >
              <div className="flex gap-2 h-full">
                ...
                <div className="grow flex flex-col justify-between h-full">
                  ...
                  {box.save && (
                    <div>
                      <p className="mt-3 text-xs md:text-[16px] font-bold self-start text-gray-600 group-hover:text-white">
                        {box.save}
                      </p>
                      <p className="mt-1 text-xs text-gray-500 self-start group-hover:text-white">
                        v&apos;single session price.
