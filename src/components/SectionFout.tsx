...
const trainingData = [
  {
    ...
    description2:
      "Begin your journey with our simple, free consultation.",
  ...
  },
  {
    ...
    description2: "Start with a 60-minute consultation and get your personalised 12-week plan.",
  ...
  },
  {
    ...
    description1:
      "Refine your alignment, improve posture, and cultivate inner strength with bespoke Pilates sessions that move beyond the reformer. Our expert instructors tailor every movement to your bodys needs, weaving breath, precision, and mindful control into every workout. Stronger support. Better posture. A more balanced you.",
    description2: "Begin your Pilates journey with a free consultation.",
    price: "Prices start at £75 per session. See pricing options below.",
    tags: ["1:1","2:1", "in-person", "on-line"],
    image:
      "https://images.pexels.com/photos/34714129/pexels-photo-34714129.jpeg",
  },
  {
    title: "PSYCHOTHERAPY",
  ...
  },
  {
    ...
    description1:
      "Soften the strain with therapeutic massage tailored to your body's needs. Whether youre recovering from training or seeking daily balance, our expert therapists combine precision techniques with restorative touch - helping you recover deeper, move freer,",
    description2:
      "Book a massage session today - feel renewed.",
    price: "Prices start at £75 per session. See pricing options below.",
    tags: ["1:1", "in-person" ],
    image:
      "https://images.pexels.com/photos/414029/pexels-photo-414029.jpeg",
...
const PersonalTrainingSection = () => {
  ...
  return (
    <div className="flex justify-center py-8 md:py-16">
      {/* <Marquee speed={200} gradient={false} pauseOnHover={true} className="w-full"> */}
