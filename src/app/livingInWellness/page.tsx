            ...
            <div className="relative max-w-[1440px] h-fit mx-auto p-6 pt-22 md:pt-0 my-0 mt-0 md:mt-22 overflow-hidden bg-[#4E4D59] rounded-xl">
                ...
                <div className="max-w-7xl mx-auto p-12 ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 z-20 items-center pt-12 mb-12">
                        ...
                        <div className="flex flex-col items-center md:items-start space-y-2 md:space-y-4 z-20 text-gray-200" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 z-20 items-center ">
                        <div className="flex flex-col items-center md:items-start space-y-2 md:space-y-4 z-20 p-8 text-gray-200 order-2 md:order-1" data-aos="zoom-in" data-aos-delay="200">
