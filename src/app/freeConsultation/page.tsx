...
// import page from './../livingInWellness/page';
...
//         w-[95%] max-w-5xl bg-white rounded-2xl my-20  z-9999 overflow-hidden border-2 mt-10 border-[#80B1FB] shadow-lg 
...
"use client"
import React, { useEffect, useState } from "react";
import { Clock, UserRound, Mail, Book } from "lucide-react";
...
const Page = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        alert("This module is under development when backend is ready.");
    };
    ...
    const FormField = ({
        ...
        <div className="relative">
            ...
            <select
                name={name}
                onChange={handleChange}
                className="w-full border-2 border-gray-200 pl-10 py-3 rounded-xl text-sm transition outline-none"
            >
                {children}
            </select>
        </div>
    ...
    return (
        <>
            {/* NORMAL SECTION (MOBILE SAFE) */}
            <section className="w-full flex justify-center px-3 md:px-6 py-16 mt-10 relative z-0 md:z-auto">
                <div
                    style={{ color: COLORS.dark }}
                    className={`w-full max-w-5xl bg-white rounded-2xl border-2 border-[#80B1FB] shadow-lg overflow-hidden
          ${closing ? "animate-slideDown" : "animate-slideUp"}`}
                >
                    {/* HEADER */}
                    <div
                    ...
                    <div className="p-6">
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter your name"
                                        onChange={handleChange}
                                        className="w-full border-2 border-gray-200 pl-10 py-3 rounded-xl text-sm outline-none"
                                    />
                                </div>
                            ...
                            <input
                                ...
                                required
                                onChange={handleChange}
                                className="w-full border-2 border-gray-200 px-3 py-3 rounded-xl text-sm outline-none"
                            />
                            ...
                            <textarea
                                ...
                                rows={3}
                                onChange={handleChange}
                                className="w-full border-2 border-gray-200 p-3 rounded-xl text-sm outline-none resize-none"
                            />

                            <button
                                type="submit"
                                style={{ backgroundColor: COLORS.primary }}
                                className="text-white py-3 rounded-xl font-bold text-lg hover:bg-[#709de1] transition"
                            >
                                Confirm Booking
                            </button>
                        </form>
